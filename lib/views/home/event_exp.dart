...
class EventExpiredPage extends StatefulWidget {
  const EventExpiredPage({Key? key}) : super(key: key);

  @override
  State<EventExpiredPage> createState() => _EventExpiredPageState();
}

class _EventExpiredPageState extends State<EventExpiredPage> {
  @override
                  ...
                  itemBuilder: (context, index) {
                    return Padding(
                      ...
                      child: Container(
                        ...
                        width: width * 0.7,
                        child: Image.network(
                          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQuyMGerpUqUXkRMsEV0euAxuwxkyeySIGMoQ&usqp=CAU',
                          ...
                          child: IconButton(
                              onPressed: () {
                                var snackBar = SnackBar(
                                  backgroundColor: red,
                                  content: Text(
                                    'This event Willbe disable in the next 12 hours',
